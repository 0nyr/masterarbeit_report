...
\section{OpenSSH memory dumps dataset}\label{sec:background:kex:dataset}
    ...
    So as to determine really how much of the dataset can be really for machine learned, we have developed a script that checks the validity of those annotations. This script called \texttt{check\_annotations.py}, is used to verify the quality, completeness, consistency and coherence of the annotations.
...
\section{A wild range of features and embeddings}
