...
\subsection{Prior work on key extraction}\label{sec:background:kex}
    ...
    \begin{lstlisting}[style=hexdump, caption={Hex Dump}]
        ...
        00000080: 10ed 193a 3456 0000 c0ab 1a3a 3456 0000  ...:4V.....:4V..
        00000090: 8085 1a3a 3456 0000 0000 0000 0000 0000  ...:4V..........
        000000a0: 0000 0000 0000 0000 d039 1a3a 3456 0000  .........9.:4V..
        000000b0: d0a0 1a3a 3456 0000 a07c 1a3a 3456 0000  ...:4V...|.:4V..
        000000c0: 502c 1a3a 3456 0000 401c 1a3a 3456 0000  P,.:4V..@..:4V..
        000000d0: c044 1a3a 3456 0000 0000 0000 0000 0000  .D.:4V..........
        000000e0: 0000 0000 0000 0000 50e4 193a 3456 0000  ........P..:4V..
    \end{lstlisting}

    This file contains the raw byte content of the heap dump of a specific version of OpenSSH. Here is a example of content of a JSON annotation file that comes with the previous RAW file:
